...
class RemoteException extends AppException {
  ...
  String? get generalServerErrorId {
    return serverError?.generalServerErrorId ?? serverError?.errors.firstOrNull?.serverErrorId;
  }

  String? get generalServerMessage {
    return serverError?.generalMessage ?? serverError?.errors.firstOrNull?.message;
  }
